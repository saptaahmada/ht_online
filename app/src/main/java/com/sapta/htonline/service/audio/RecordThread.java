...
import com.sapta.htonline.Settings;
import com.sapta.htonline.jni.Native;
import com.sapta.htonline.jni.celtConstants;
import com.sapta.htonline.service.MumbleProtocol;
import com.sapta.htonline.service.MumbleService;
import com.sapta.htonline.service.PacketDataStream;
	...
	public RecordThread(final MumbleService service) {
		...
		for (final int s : new int[] { 48000, 44100, 22050, 11025, 8000 }) {
			...
			if (bufferSize > 0) {
				...
				//break; NOTE FOR FIRO : COMMENTED FOR DEBUGGING PURPOSE. UNCOMMENT THIS LATER!
			}
		}
