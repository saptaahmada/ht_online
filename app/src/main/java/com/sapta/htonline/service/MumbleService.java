...
import com.sapta.htonline.service.audio.RecordThread;
...
public class MumbleService extends Service {
	...
	public void deleteChannel(final int channelId) {
		mProtocol.delChannel(channelId);
	}
	public void addChannel(final String channelName, final int channelID) {
		mProtocol.addChannel(channelName, channelID);
	}

	public void setDeafened(boolean deafened){
		mProtocol.setDeafened(deafened);
	}
