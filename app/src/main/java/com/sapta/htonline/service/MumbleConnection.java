...
import com.sapta.htonline.MumbleProto.Authenticate;
import com.sapta.htonline.MumbleProto.Version;

import com.sapta.htonline.Globals;
import com.sapta.htonline.service.MumbleProtocol.MessageType;
...
//		}
	...
	private void handleProtocol() throws IOException, InterruptedException {
		...
		v.setRelease("MumbleAndroid 0.0.1-3");
	...
	protected Socket connectTcp(InputStream certificate) throws NoSuchAlgorithmException,
			KeyManagementException, IOException, UnknownHostException, CertificateException, KeyStoreException {
